...
folder_lean_articles=$folder_current_script/../Lean4/Articles
folder_lean_tools=$folder_current_script/../Lean4/Tools
...
script_insert_indexes_and_links=$folder_current_script/InsertIndexesAndLinks.py
...
for file_article_md in $folder_markdown/*; do
    ...
    python3 $script_insert_code $file_article_md $folder_rocq_articles $folder_lean_articles | \
...
python3 $script_insert_indexes_and_links $folder_html $folder_rocq_articles $folder_rocq_tools $file_rocq_project $folder_lean_articles $folder_lean_tools $file_lean_project $homepage_file
